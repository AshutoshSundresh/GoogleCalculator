...
.method constructor <init>(Lafc;Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    ...
    iput-object p2, p0, Lakx;->a:Landroid/os/Bundle;

    iput-wide p3, p0, Lakx;->b:J

    iput-object p5, p0, Lakx;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;
...
.method protected final a(Lakn;)V
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Lakx;->a:Landroid/os/Bundle;

    iget-wide v2, p0, Lakx;->b:J

    iget-object v4, p0, Lakx;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;

    new-instance v5, Laky;

    invoke-direct {v5, p0}, Laky;-><init>(Lakx;)V

    move-object v0, p1

    invoke-interface/range {v0 .. v5}, Lakn;->b(Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;Lakh;)V
    :try_end_0
