...
.method constructor <init>(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object p1, p0, Lbkk;->a:Landroid/content/Intent;

    iput-object p2, p0, Lbkk;->b:Landroid/content/BroadcastReceiver$PendingResult;

    new-instance v0, Lbkl;

    invoke-direct {v0, p0, p1}, Lbkl;-><init>(Lbkk;Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lbkk;->d:Ljava/util/concurrent/ScheduledFuture;
...
.method final declared-synchronized a()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lbkk;->c:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lbkk;->b:Landroid/content/BroadcastReceiver$PendingResult;

    invoke-virtual {v0}, Landroid/content/BroadcastReceiver$PendingResult;->finish()V

    iget-object v0, p0, Lbkk;->d:Ljava/util/concurrent/ScheduledFuture;
