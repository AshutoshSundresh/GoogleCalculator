...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lbkt;->c:Lku;

    const/4 v0, 0x0

    iput-object v0, p0, Lbkt;->d:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lbkt;->a:Ljava/util/Queue;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lbkt;->e:Ljava/util/Queue;

    return-void
.end method

.method public static declared-synchronized a()Lbkt;
    .locals 2
...
.method private final b(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v2, p0, Lbkt;->c:Lku;

    monitor-enter v2

    :try_start_0
    iget-object v0, p0, Lbkt;->c:Lku;
    ...
    :goto_0
    :try_start_1
    iget-object v0, p0, Lbkt;->d:Ljava/lang/Boolean;
    ...
    invoke-static {p1, p2}, Lio;->a_(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    :try_start_3
    iget-object v3, p0, Lbkt;->c:Lku;

    invoke-virtual {p2}, Landroid/content/Intent;->getAction()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4, v0}, Lku;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_0
    iget-object v0, p0, Lbkt;->a:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, v0}, Lbkt;->b(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :pswitch_1
    iget-object v0, p0, Lbkt;->e:Ljava/util/Queue;
...
.method public final a(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Lbkt;->a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
